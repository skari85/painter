...
const NPC_APPRAISALS = {
  ...
  waitingMarshal: 'Number Annika. Estimate: one ticket per identity. Current number: nobody yours.',
  waitingClosedAttendant: 'Yesterday Moss. Condition: open during closure, closed during opening.',
  waitingApologist: 'Sorry Sørensen. Apology edition, unlimited. Bench capacity: emotionally one.',
  waitingSponsorA: 'Sponsorship Officer One. Armed with placement, reach, and a chrome interpretation of consent.',
  waitingSponsorB: 'Sponsorship Officer Two. Brand safety made flesh. Flesh pending approval.',
  waitingStriker: 'Camille Toujours. Labor value: deliberately unavailable to the market.',
  waitingDamp: 'Nigel Mildew. Condition report: British. Restoration would damage the atmosphere.',
  waitingJuryClerk: 'Patience Quorum. Five nations entered, one spreadsheet leaving.',
...
const OBJECT_APPRAISALS = {
  ...
  waitingTicketMachine: 'The ticket machine. Current estimate: forty-seven minutes. Provenance: the person ahead of you.',
  waitingClosedArtwork: 'The artwork closed yesterday. The queue remains open as a durational rebuttal.',
  waitingRecursiveSign: 'A sign directing this queue toward a more established queue. Estimate: three transfers and one lost afternoon.',
  waitingVipBarrier: 'The VIP barrier. Movement: backward. Access: visibly aspirational.',
  waitingNordicSign: 'The Nordic Pavilion. One bench, one apology, seating subject to emotional availability.',
  waitingGermanDoor: 'The German Pavilion door. Industrial scale, domestic outcome. A smaller authority waits behind it.',
  waitingAmericanSponsor: 'Armed sponsorship. The gift shop has secured the perimeter around your desire to browse.',
  waitingFrenchPlacard: 'The French Pavilion is on strike. Labor estimate: priceless. Opening estimate: withdrawn.',
  waitingBritishLeak: 'British damp. Medium: weather, plaster, inherited reluctance. Conservation has surrendered.',
  waitingScoreboard: 'The survival board. National culture, reduced to who can keep standing in public longest.',
  waitingJuryDesk: 'The International Jury desk. Five flags entered. One queue leaves with a plaque.',
  nowOrNeverBoard: 'The departure board. Every artist is on time for a different version of being too late.',
  nowOrNeverGate: 'A gate for the next big thing. Boarding has moved to a smaller, more exclusive gate.',
  nowOrNeverLuggage: 'A suitcase full of press releases. The artist has lost the train and kept the branding.',
  nowOrNeverClock: 'The terminal clock. It is accurate within the current trend cycle.',
