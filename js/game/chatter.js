...
export class ChatterEngine extends Emitter {
  ...
  update(dt, near, ctx) {
    ...
    // These rooms have long authored exchanges managed by NPCManager. Generic
    // two-line chatter would interrupt the pauses that make each pair readable.
    if (ctx.zoneKey === 'upAndCumming' || ctx.zoneKey === 'vacantEditions') return;
